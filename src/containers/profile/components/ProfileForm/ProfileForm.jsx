...
import { getCardSelector, getTokenSelector, getIsUpdatedSelector,  cardUpdateRequest, cardDetailsRequest  } from "../../../profile/store";
...
export function ProfileForm() {
  ...
  const isUpdated = useSelector(state => getIsUpdatedSelector(state.profileReducer));
